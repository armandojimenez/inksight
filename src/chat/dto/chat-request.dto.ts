...
import { MAX_MESSAGE_LENGTH } from '@/common/constants/chat.constants';
...
export class ChatRequestDto {
  ...
  @MaxLength(MAX_MESSAGE_LENGTH, { message: `Message cannot exceed ${MAX_MESSAGE_LENGTH} characters` })
  message!: string;
}
